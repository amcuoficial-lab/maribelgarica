...
export default function AdminConfigPage() {
  ...
  const seedDatabase = async () => {
    const defaultSections = [
      ...
      { id: 'trayectoria', section_name: 'Fundadora de 10 museos y proyectos', section_order: 4, content: { title: 'Fundadora de 10 museos y proyectos', description: 'Tres décadas recorriendo escenarios, museos y comunidades con el poder transformador de las historias.', projects: [{ title: 'Voces del Sur', description: 'Espectáculo de narración oral con vestuario tradicional en el Salón Auditorio.', photo: '/fotos/escena.jpg', tag: 'Narración Oral' }] } },
