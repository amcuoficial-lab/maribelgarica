export default function PodcastSection({ content }) {
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl text-crema">
            {content.title || 'El Podcast de Maribel García'}
          </h2>
          <p className="text-crema/60 mt-4 max-w-xl mx-auto whitespace-pre-line">
            {content.description || 'Relatos, conversaciones y reflexiones sobre la cultura, la memoria y el poder de las palabras.'}
          </p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg border border-dorado/25 shadow-2xl rounded-3xl p-6 md:p-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <p className="text-crema font-semibold text-sm">Escuchá Ahora</p>
          ...
          {/* Spotify embed */}
          <iframe
            src={content.spotify_url || "https://open.spotify.com/embed/show/3wFzIHyeRQlY93prJVH2X4?utm_source=generator&theme=0"}
            width="100%"
            height="352"
            frameBorder="0"
